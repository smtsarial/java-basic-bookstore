...
public class TraversalExamples {
  ...
  /** Returns total disk space for subtree of T rooted at p. */
  public static String tree_concat(Tree<String> T, Position<String> p) {
    String subtotal = p.getElement();    // we assume element represents space usage
    for (Position<String> c : T.children(p))
      subtotal += tree_concat(T, c);
    return subtotal;
  }
  ...
  public static void main(String args[]) {
	  LinkedBinaryTree<String> letters = new LinkedBinaryTree<>() ;
	  
	  Position<String> r = letters.addRoot("A") ;
	  Position<String> c1 = letters.addLeft(r, "B") ;
	  Position<String> c2 = letters.addRight(r, "C") ;
	  Position<String> c6 = letters.addLeft(c1, "b") ;
	  Position<String> c3 = letters.addLeft(c2, "D") ;
	  Position<String> c4 = letters.addRight(c2, "E") ;
	  
	  /*for ( Position<String> node : letters.positions())
		  System.out.println(node.getElement());*/
	  
	  //System.out.println(tree_concat(letters, letters.root())) ;
	  
	  //parenthesize(letters, letters.root()) ;
	  
	  System.out.println("\n") ;
	  //printPreorderIndentSlow(letters)  ;
	  //printPreorderIndent(letters, letters.root(),0)  ;
	  
	  ArrayList<Integer> path = new ArrayList<>(5) ;
	  path.add(0) ;
	  System.out.println("\n") ;
	  printPreorderLabeled(letters, letters.root(), path) ;
